        ...
        <div className="flex items-center justify-center h-screen">
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100">
                ...
                <form action="" className="space-y-6">
                    ...
                    <button className="block w-full p-3 text-center rounded-sm bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:border-green-700 focus:ring focus:ring-green-200">
                        Login
                    </button>
                </form>
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-400">
                    ...
                    <a rel="noopener noreferrer" className="underline dark:text-gray-100">
                        Sign Up
                    </a>
                </p>
            </div>
